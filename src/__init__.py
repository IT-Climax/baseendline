...
from .db.models import RoleEnum, GenderEnum, User, Section, Participant, Enumerator, QuestionPhase, QuestionBase, QuestionOptions, QuestionAnswer, \
    AnswerOptionSelected, ParticipantClass, FGDParticipant, FGDQuestion, FGDQuestionOption, FGDAnswer
...
def create_app():
    ...
    @app.route('/details')
    def details():
        return {'name': 'InsightBridge',
                'description': 'Making data collection easy and turning community stories into real impact'}
